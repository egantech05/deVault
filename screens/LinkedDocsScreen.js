...
export default function LinkedDocumentsScreen() {
  ...
  return (
    <View style={commonStyles.contentContainer}>
      ...
      {/* Search (uses ../components/SearchBar) */}
      ...
      {/* Add Button */}
      <DashedRowButton label="Add Document" onPress={() => setModalVisible(true)} />
      ...
      {loading ? (
        ...
        <View style={{ marginTop: 12 }}>
          {rows.map((r) => {
            ...
            return (
              <View key={r.id} style={[linkedDocRowBaseStyle, linkedDocRowShadowStyle]}>
                {/* Left side text */}
                <View style={{ flex: 1, paddingRight: 10 }}>
                  ...
                  <Text style={{ color: "#999", fontSize: 12, marginTop: 3 }}>{createdAt}</Text>
                </View>
